...
- [ ] **步骤 3：服务列表启用开关 disabled + tooltip**
...
- [ ] **步骤 1：替换 ENGINE_META 并新增 engineIcon**
...
- [ ] **步骤 4：更新 AGENTS.md 与 CLAUDE.md 架构关键点**
