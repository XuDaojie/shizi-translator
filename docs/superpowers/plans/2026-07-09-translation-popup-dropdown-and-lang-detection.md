...
- [x] **步骤 1：在 `[dependencies]` 末尾加 `sys-locale`**
...
- [x] **步骤 3：替换 DEFAULT_TARGET_LANG 常量**
...
- [x] **步骤 4：from_env 改用 OS 语言（保留环境变量覆盖）**
...
- [x] **步骤 5：normalized 改用 FALLBACK_TARGET_LANG**
...
- [x] **步骤 4：service.rs 构造 Finished 暂传 None**
...
- [x] **步骤 3：改造 MockLlmProvider::stream_translate**
...
- [x] **步骤 1：translate.html .lang-badge 去静态文案**
...
- [x] **步骤 2：translate.css .lang-badge 空时隐藏**
...
- [x] **步骤 3：translate.js 新增 langBadge 引用与 setLangBadge**
...
- [x] **步骤 4：renderLangLabels 末尾联动 setLangBadge**
...
- [x] **步骤 5：getCard 返回的 ref 加 detectedSourceLang 字段**
...
- [x] **步骤 6：renderTranslationEvent started 设置「检测中…」**
...
- [x] **步骤 7：renderTranslationEvent finished 记录并显示 detectedSourceLang**
...
- [x] **步骤 8：updateBatchStatus allFinished 统一取首个非 null**
...
- [x] **步骤 1：translate.html .lang-side 改 button + 插入 .lang-picker**
...
- [x] **步骤 2：translate.css 删 .lang-dropdown* 并新增 .lang-picker***
...
- [x] **步骤 3：translate.js LANGUAGES 补 english**
...
- [x] **步骤 4：translate.js 新增 picker 元素引用**
...
- [x] **步骤 5：translate.js 删浮层逻辑、新增 inline picker**
...
- [x] **步骤 6：translate.js 绑定 picker 事件、改 langSource/langTarget 点击**
...
- [x] **步骤 3：CLAUDE.md / AGENTS.md 同步架构关键点**
