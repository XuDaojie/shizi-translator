...
- [x] **步骤 3：写入 git 依赖与 build.rs（最少让编译过）**
...
- [x] **步骤 1：实现最小 STA host API（无完整五区）**
...
- [x] **步骤 1：对照 Open Design 清单（无代码测试，勾选实现）**
...
- [x] **步骤 1：确认 default 构建不编译 GDI 大文件**
