...
<template>
  <div class="toolbar" data-tauri-drag-region>
    <div class="toolbar-left">
      <button class="toolbar-btn" :class="{ active: pinned }" :title="t(pinned ? 'popup.tooltip.unpin' : 'popup.tooltip.pin')" :aria-label="t(pinned ? 'popup.tooltip.unpin' : 'popup.tooltip.pin')" @click="togglePin">
    ...
    <div class="toolbar-right">
      <button class="toolbar-btn" :title="t('popup.tooltip.ocr')" :aria-label="t('popup.tooltip.ocr')" @click="triggerOcr">
      ...
      <button class="toolbar-btn" :title="t('popup.tooltip.settings')" :aria-label="t('popup.tooltip.settings')" @click="openSettings">
