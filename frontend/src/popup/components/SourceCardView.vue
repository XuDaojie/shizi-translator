...
<template>
  <div class="source-card" @click="emit('focus')">
    ...
    <div class="source-meta">
      <button class="meta-btn" type="button" :title="t('popup.tooltip.speakSource')" :aria-label="t('popup.tooltip.speakSource')" @click.stop="emit('speak')">
      ...
      <button class="meta-btn" type="button" :title="t('popup.tooltip.copySource')" :aria-label="t('popup.tooltip.copySource')" @click.stop="emit('copy')">
