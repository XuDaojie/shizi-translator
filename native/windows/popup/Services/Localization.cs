...
public static class Localization
{
    ...
    private static readonly Dictionary<string, string> Zh = new(StringComparer.Ordinal)
    {
        ...
        ["popup.tooltip.minimize"] = "最小化",
        ["popup.tooltip.close"] = "关闭",
        ["popup.tooltip.theme"] = "主题",
        ...
        ["popup.action.expandFull"] = "展开全文",
        ["popup.action.collapseFull"] = "收起",
    ...
    private static readonly Dictionary<string, string> En = new(StringComparer.Ordinal)
    {
        ...
        ["popup.tooltip.minimize"] = "Minimize",
        ["popup.tooltip.close"] = "Close",
        ["popup.tooltip.theme"] = "Theme",
        ...
        ["popup.action.expandFull"] = "Show more",
        ["popup.action.collapseFull"] = "Show less",
