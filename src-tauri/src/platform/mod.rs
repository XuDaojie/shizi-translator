...
#[cfg(target_os = "windows")]
pub use windows::{capture_screen, cursor_logical_context, cursor_monitor_physical_bounds, cursor_monitor_scale_factor, recognize_region};
...
#[cfg(not(target_os = "windows"))]
pub use unsupported::{capture_screen, cursor_logical_context, cursor_monitor_physical_bounds, cursor_monitor_scale_factor, recognize_region};
